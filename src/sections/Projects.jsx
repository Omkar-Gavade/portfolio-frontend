...
>
  ...
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
    ...
    <div className="bg-gray-50 dark:bg-white/5 
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {[
          ...
          "JWT Authentication","REST APIs","Redis","Chart.js",
          "Role-Based Access","Market Data Handling","Tailwind CSS",
        ].map((tech) => (
          <span
            key={tech}
    ...
    <div className="bg-gray-50 dark:bg-white/5 
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        {[
          "React","Node.js","Express","MongoDB","AI SDK",
          "Streaming Responses","Prompt Engineering","REST APIs",
          "Rate Limiting","Message Persistence","API Orchestration","Tailwind CSS",
        ].map((tech) => (
          <span
            key={tech}
            className="px-3 py-1 rounded-full text-xs 
